...
*/
	...
	$sql = "SELECT * FROM public.\"Information\"";

	if($period == "SelectPeriod" && $accountID == "" && $clientID == "" && $eventType == "EventType")
	{
	...
	$result = $db->query($sql);
        ...
        /*        echo "<a href=\"#\" id=\"nfc\" onClick=\"fnExcelReport()\">download</a>";
				...
				echo "<thead>
						<tr><th>Log ID</th><th>Client ID</th><th>Account ID</th><th>Event Type</th><th>Timestamp</th></tr>
					</thead>";
