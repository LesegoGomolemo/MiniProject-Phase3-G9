  ...
  switch (logType) {
    case 'auth':
      for (i = 0; i < holder.logs.length; i++) {
        ...
        var sql =
          ...
          ' ("logID","logType","cardID","cardType","clientID","description","success","timestamp") VALUES (' +
          logID +
          ', ' +
    ...
    case 'atm':
      for (i = 0; i < holder.logs.length; i++) {
        ...
        var sql =
          'INSERT INTO public."Simulation" ("logID","atmID","clientID","timestamp","eventType") VALUES (' +
          logID +
          ', ' +
