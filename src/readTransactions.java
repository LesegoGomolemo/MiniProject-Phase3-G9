...
public class readTransactions{
    ...
    public static Set<String> targetT(Set<String> dataSet, String target) {
        Set<String> data = new HashSet<>();
        int count = 0;
    ...
    public static String generateReport(Set<String> dataSet) {
        ...
        Set<String> data = new HashSet<>();
        String[] transactions = new String[]{"Withdrawal", "MiniStatement", "Deposit"};
        ...
        for(String s: transactions) {
            ...
            double success = count(data, "200");
            double fail = count(data, "500");

            
            double percent = fail/(success + fail) * 100;

            stringBuilder.append(count(data, "500") + " failed attempts\n");
            stringBuilder.append(count(data, "200") + " successful attempts\n");
